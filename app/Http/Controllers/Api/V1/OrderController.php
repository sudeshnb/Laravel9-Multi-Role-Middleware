    ...
    public function place_order(Request $request)
    {
        ...
        foreach ($request['cart'] as $c) {
            ...
            if ($product) {
                ...
                return response()->json(['errors' => [['code' => 'food', 'message' => 'not found!']]], 401);
            }
        }
        ...
        return response()->json(['errors' => [['code' => 'order_time', 'message' => trans('messages.failed_to_place_order')]]], 403);
    }
